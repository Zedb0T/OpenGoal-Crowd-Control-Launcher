...
AppdataDIR = os.path.join(os.getenv("APPDATA"), "OpenGOAL-CrowdControl","")
EnvDIR = os.path.join(AppdataDIR,"env")
GoalDIR = os.path.join(AppdataDIR,"openGOAL")
print("TEST " + EnvDIR)

#env values
load_dotenv(os.path.join(EnvDIR,"command_cooldowns.env"))
load_dotenv(os.path.join(EnvDIR,"command_durations.env"))
load_dotenv(os.path.join(EnvDIR,"twitch_settings.env"))
load_dotenv(os.path.join(EnvDIR,"unused.env"))
load_dotenv(os.path.join(EnvDIR,"command_enabled.env"))
...
"""
Probably useful later in another part of launcher.
...
#paths
PATHTOGOALC = GoalDIR + "\goalc.exe"
PATHTOGK = GoalDIR +"\gk.exe -boot -fakeiso -debug -v"
