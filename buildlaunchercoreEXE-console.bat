...
pyinstaller --onefile  "Examples/Crowd Control Main Menu.py"  --icon Images\appicon.ico --add-data "Images;Images/" --add-data "Images\Launcher_BG.png;."
...
pyinstaller --onefile  "Examples/Command Cooldowns Menu.py"  --icon Images\appicon.ico --add-data "Images;Images/" --add-data "Images\Launcher_BG.png;." 
...
pyinstaller --onefile  "Examples/Command Durations Menu.py"  --icon Images\appicon.ico --add-data "Images;Images/" --add-data "Images\Launcher_BG.png;." 
...
pyinstaller --onefile  "Examples/Enabled Commands Menu.py"  --icon Images\appicon.ico --add-data "Images;Images/" --add-data "Images\Launcher_BG.png;." 
...
pyinstaller --onefile  "Examples/Settings Main Menu.py"  --icon Images\appicon.ico --add-data "Images;Images/" --add-data "Images\Launcher_BG.png;." 
...
pyinstaller --onefile  "Examples/Twitch Settings Menu.py"  --icon Images\appicon.ico --add-data "Images;Images/" --add-data "Images\Launcher_BG.png;." 
