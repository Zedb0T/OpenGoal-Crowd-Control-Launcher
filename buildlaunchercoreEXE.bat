...
move "%mypath%dist\Crowd Control Main Menu.exe" "%mypath%/Release"
...
move "%mypath%dist\Command Cooldowns Menu.exe" "%mypath%/Release"
...
move "%mypath%dist\Command Durations Menu.exe" "%mypath%/Release"
...
move "%mypath%dist\Enabled Commands Menu.exe" "%mypath%/Release"
...
move "%mypath%dist\Twitch Settings Menu.exe" "%mypath%/Release"
...
move "%goalROOT%data" "%mypath%/Release/openGOAL/data"
